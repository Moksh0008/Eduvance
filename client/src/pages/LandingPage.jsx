...
const slides = [
  {
    ...
    desc: 'Enter subjects, exams, and topics.',
    color: 'var(--color-accent)',
  },
  {
    emoji: '🧠',
    title: 'Eduvance analyzes',
    desc: 'Priority scores computed from your data.',
    color: 'var(--color-accent-2)',
  },
  {
    emoji: '🗓',
    title: 'Get your plan',
    desc: 'What, when, and how long — decided for you.',
    color: 'var(--color-low)',
  },
  {
    emoji: '🎯',
    title: 'Quiz & adapt',
    desc: 'Test yourself. Eduvance replans automatically.',
  ...
  return (
    <div className="bg-canvas min-h-screen">
      ...
      <main className="relative">
          ...
          <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-16">
            ...
            >
              ...
              <div className="mt-6 flex justify-center gap-6 lg:justify-start">
                {[
                  { emoji: '🎯', label: 'Priority scoring' },
                  { emoji: '🔄', label: 'Auto-replan' },
                  { emoji: '📊', label: 'Quiz analytics' },
                ].map((s) => (
        ...
        {/* Quick feature grid — visual, not text-heavy */}
        ...
        <section className="relative px-4 py-20 text-center sm:px-6">
          ...
          >
            ...
            <p className="mx-auto mt-3 max-w-md text-sm text-ink-2">
              Build your preparation strategy in minutes.
            </p>
